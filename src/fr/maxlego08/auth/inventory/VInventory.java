...
public abstract class VInventory extends ZUtils{
	...
	protected abstract boolean openMenu(Authme plguin, Player player, int page, Object... args);

	protected abstract void onClick(InventoryClickEvent event, Authme plguin, Player player);

	protected abstract void onClose(InventoryCloseEvent event, Authme plugin, Player player);

	protected abstract void onDrag(InventoryDragEvent event, Authme plugin, Player player);
